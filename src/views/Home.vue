<template>
  <v-container>
    <h2 class=" font-weight-black text-h5 text-center mb-3 mt-5">
  ...
  >
    <v-img
      src="https://ik.imagekit.io/cbpz03zxgou/storage/noticias/noticia-969.jpg"
      height="200px"
    ></v-img>

    <v-card-title>
      SEMPRE é tempo de Prevenir
    </v-card-title>

    <v-card-subtitle>
      Vamos vencer este problema JUNTOS
    </v-card-subtitle>
